...
We can directly call static method and static variable by class name.
We can directly call static method and static variable without class name.
...
public class Example {
	...
	// non static variable
		...
		public static void main(String[] args) {
			...
			// Rule=> calling non static method and variable by object name
			obj.test1();
			obj.test2();
			...
			System.out.println("************Static method/ variable called by classname*************");
			...
			System.out.println("**************** Static method / variale called directly*******");
